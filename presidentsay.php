  ...
  <?php include "includes/header.php"; ?> 
    <div class="container">
        <div class="box"><br><br><br>
            <img src="say_photo/<?php echo $row['president_img']; ?>" alt="Photo">
            
                <h2 style="font-weight: 800;font-size: 25px"><?php echo $row['president_name']; ?></h2><br>
                <h3 style="font-size: 22px;font-weight: 500;"><?php echo "( ".$row['president_quali']." )" ?></h3><br>
                <h3>President</h3>
            
        </div>
        <div class="About">
            <ul>
                <h2>From The President's Table</h2>
            </ul>
                <p><?php echo $row['president_say']; ?></p>
            </ul>
        </div>
    </div>
