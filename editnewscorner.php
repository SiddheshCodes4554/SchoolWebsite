...
if(isset($_REQUEST['update_id']))
{
	try
	{
		...
		$editselectqry = "SELECT * FROM ne_co WHERE id='$id'"; 
...
if(isset($_REQUEST['btn_update']))
{
	try
	{
		...
		if(!isset($errorMsg))
		{
			$updateqry = "UPDATE ne_co SET title='$title', description='$description', image='$image_file', content='$content' WHERE id='$id'"; 
	...
	<div class="container">
		...
		?>   
			...
			<form method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<p><img src="newscornerphotos/<?php echo $image; ?>" height="100" width="100" /></p>
				</div>
				</div>
				...
				<div class="col-sm-12">
				<textarea name="content" id="summernote"><?php echo htmlentities($content); ?></textarea>
				</div>
				</div>
