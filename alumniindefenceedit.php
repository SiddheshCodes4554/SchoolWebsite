...
if(isset($_REQUEST['update_id']))
{
	try
	{
		...
		$editselectqry = "SELECT * FROM alumni_defence WHERE id='$id'"; 
...
if(isset($_REQUEST['btn_update']))
{
	try
	{
		...
		$directory="alumniindefencephoto/"; 
		...
		if(!isset($errorMsg))
		{
			$updateqry = "UPDATE alumni_defence SET name='$name', designation='$designation', image='$image_file' WHERE id='$id'"; 
			$updateresult = mysqli_query($conn, $updateqry);
			 
			if($updateresult)
			{
				$updateMsg="File Updated Successfully.......";	
				header("refresh:3;managealumniindefence.php");	
		}
	}
}
	catch(PDOException $e)
...
<title>EDIT ALUMNI IN DEFENCE</title>
	...
	<div class="container">
		...
		?>   
			...
			<form method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<p><img src="alumniindefencephoto/<?php echo $image; ?>" height="100" width="100" /></p>
				</div>
				</div>
