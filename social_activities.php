...
<body style="background-image: linear-gradient(120deg, #f6d365 0%, #fda085 100%);">
	...
	<h2 class="text-center mt-2 font-weight-bold" style="color: black;margin-bottom: 10px;">Social Activities</h2>
	    <div class="container mt-2">
        <div class="row g-3">
        	<?php 

		$getqry = "SELECT * FROM cer WHERE type='social_activity' ORDER BY id DESC";
		$getresult = mysqli_query($conn, $getqry);
		while($row = mysqli_fetch_assoc($getresult)){
	?>
            <div class="col-12 col-md-6 col-lg-4 mb-2">
                <div class="card" style="border: 2px solid darkkhaki;">
                    <img src="socialactivityphoto/<?php echo $row['image']; ?>" class="card-img-top img-fluidm" alt="<?php echo $row['cap']; ?>"><hr class="border border-dark">
