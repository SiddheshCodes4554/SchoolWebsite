...
if(isset($_REQUEST['btn_insert']))
{
	try
	{
		...
		$path="socialactivityphoto/".$image_file; 
		...
		{	
			if(!file_exists($path)) 
			{
				if($size < 5000000)
				{
					move_uploaded_file($temp, "socialactivityphoto/" .$image_file); 
				}
				else
				{
		...
		if(!isset($errorMsg))
		{
			...
			if(!$insertqry)
			{
				...
				header("refresh:3;addsocialactivity.php"); 
			} else {
			$insertMsg="Social Activity Upload Successfully........"; 
				header("refresh:3;managesocialactivity.php");
		}
	}
	}
...
<link rel="icon" type="image/x-icon" href="Images/Logo.ico">
	...
	<body>
		<a class="btn btn-warning mt-3 ml-2" href="manageachievement.php"><i class="fas fa-arrow-left"></i> Back</a>
	<div class="wrapper">
	<div class="container">			
		<div class="col-lg-12">	
		<?php
