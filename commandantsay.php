    ...
    <div class="container">
        <div class="box"><br><br><br>
            <img src="say_photo/<?php echo $row['commandant_img']; ?>" alt="Photo">
                ...
                <h2 style="font-weight: 800;font-size: 25px"><?php echo $row['commandant_name']; ?></h2><br>
                <h3 style="font-size: 22px;font-weight: 500;"><?php echo "( ".$row['commandant_quali']." )" ?></h3><br>
                <h3>Commandant</h3>
            
        </div>
        <div class="About">
            <ul>
                <h2>From The Commandant's Table</h2>
            </ul>
                <p><?php echo $row['commandant_say']; ?></p>
            </ul>
        </div>
    </div>
