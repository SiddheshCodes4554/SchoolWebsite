...
if(isset($_REQUEST['update_id']))
{
	try
	{
		...
		$editselectqry = "SELECT * FROM bod WHERE id='$id'"; 
...
if(isset($_REQUEST['btn_update']))
{
	try
	{
		...
		if(!isset($errorMsg))
		{
			$updateqry = "UPDATE bod SET name='$name', post='$post', image='$image_file' WHERE id='$id'"; 
	...
	<div class="container">
		...
		?>   
			...
			<form method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<p><img src="bodphoto/<?php echo $image; ?>" height="100" width="100" /></p>
				</div>
				</div>
