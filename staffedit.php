...
if(isset($_REQUEST['update_id']))
{
	try
	{
		...
		$editselectqry = "SELECT * FROM staff_t WHERE id='$id'"; 
...
if(isset($_REQUEST['btn_update']))
{
	try
	{
		...
		if(!isset($errorMsg))
		{
			$updateqry = "UPDATE staff_t SET name='$name',  quali='$qualification', subject='$subject',  join_date='$join_date', post='$post', image='$image_file' WHERE id='$id'"; 
	...
	<div class="container">
		...
		?>   
			...
			<form method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<p><img src="staffphoto/<?php echo $image; ?>" height="100" width="100" /></p>
				</div>
				</div>
