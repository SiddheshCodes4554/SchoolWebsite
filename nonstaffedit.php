...
if(isset($_REQUEST['update_id']))
{
	try
	{
		...
		$editselectqry = "SELECT * FROM staff_t WHERE id='$id' AND type='nonteaching'"; 
...
if(isset($_REQUEST['btn_update']))
{
	try
	{
		...
		if(!isset($errorMsg))
		{
			$updateqry = "UPDATE staff_t SET name='$name',  quali='$qualification', post='$post', image='$image_file' WHERE id='$id' AND type='nonteaching'"; 
	...
	<div class="container">
		...
		?>   
			...
			<form method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="col-sm-6">
				<input type="text" name="quali" class="form-control" value="<?php echo $quali; ?>" required/>
				</div>
				</div>
				...
				<p><img src="nonstaffphoto/<?php echo $image; ?>" height="100" width="100" /></p>
				</div>
				</div>
