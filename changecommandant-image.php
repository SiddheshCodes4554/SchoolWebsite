...
$query=mysqli_query($conn, "update says set commandant_img='$imgnewfile' where id='$uid'");
if ($query) {
unlink($oldprofilepic);
echo "<script>alert('Profile pic updated successfully');</script>";
echo "<script type='text/javascript'> document.location ='eaditprincipal.php'; </script>";
}else{
...
<input type="hidden" name="oldpic" value="<?php echo $row['principal_img'];?>">
